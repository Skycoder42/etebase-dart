// ignore_for_file: require_trailing_commas, non_constant_identifier_names, prefer_expression_function_bodies, lines_longer_than_80_chars, comment_references, avoid_positional_boolean_parameters, camel_case_types
...
class EtebaseAccount extends ffi.Opaque {}

class EtebaseClient extends ffi.Opaque {}

class EtebaseCollection extends ffi.Opaque {}

class EtebaseCollectionInvitationManager extends ffi.Opaque {}

class EtebaseCollectionListResponse_Collection extends ffi.Opaque {}

class EtebaseCollectionManager extends ffi.Opaque {}

class EtebaseCollectionMember extends ffi.Opaque {}

class EtebaseCollectionMemberManager extends ffi.Opaque {}

class EtebaseFetchOptions extends ffi.Opaque {}

class EtebaseFileSystemCache extends ffi.Opaque {}

class EtebaseItem extends ffi.Opaque {}

class EtebaseItemListResponse_Item extends ffi.Opaque {}

class EtebaseItemManager extends ffi.Opaque {}

class EtebaseItemMetadata extends ffi.Opaque {}

class EtebaseIteratorListResponse_CollectionMember extends ffi.Opaque {}

class EtebaseIteratorListResponse_Item extends ffi.Opaque {}

class EtebaseIteratorListResponse_SignedInvitation extends ffi.Opaque {}

class EtebaseRemovedCollection extends ffi.Opaque {}

class EtebaseSignedInvitation extends ffi.Opaque {}

class EtebaseUser extends ffi.Opaque {}
