...
static void etebase_flutter_plugin_handle_method_call(
    EtebaseFlutterPlugin* self,
...
static void method_call_cb(FlMethodChannel* channel, FlMethodCall* method_call,
                           gpointer user_data) {
  EtebaseFlutterPlugin* plugin = ETEBASE_FLUTTER_PLUGIN(user_data);
  etebase_flutter_plugin_handle_method_call(plugin, method_call);
}
